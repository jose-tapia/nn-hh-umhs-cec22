...
- **Experiment notebook**: [CUSTOMHyS_runbook.ipynb](./CUSTOMHyS_runbook.ipynb); Description of the experiment configuration files and a brief tutorial to run the modules in google colab ([Google Colab notebook](https://colab.research.google.com/drive/1NI7FM0XU3ldRrd9bcnLGgPFS7e0tmEZZ?usp=sharing))
