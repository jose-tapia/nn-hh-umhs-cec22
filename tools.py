...
if __name__ == '__main__':
    ...
    experiment_kind = parser.parse_args().experiment_kind[0]
    experiment_name = parser.parse_args().experiment[0]
    preprocess_files(main_folder='data_files/raw-'+experiment_name, 
                     kind=parser.parse_args().experiment_kind[0],
